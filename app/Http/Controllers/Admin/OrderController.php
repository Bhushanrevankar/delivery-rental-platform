    ...
    public function details(Request $request, $id)
    {
        ...
        if (isset($order)) {
            ...
            if (isset($order->store)) {
                $deliveryMen = DeliveryMan::whereHas('zones', function ($q) use ($order) {
                    $q->where('zones.id', $order->store->zone_id);
    ...
    public function all_details(Request $request, $id)
    {
        ...
        if (isset($order)) {
            if (isset($order->store)) {
                ...
                $deliveryMen = isset($order->zone_id) ? DeliveryMan::whereHas('zones', function ($q) use ($order) {
