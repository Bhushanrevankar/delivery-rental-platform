        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
                ...
                Route::group(['middleware' => ['module:deliveryman']], function () {
                    ...
                    Route::get('prepaid-cards', [PrepaidCardController::class, 'index'])->name('prepaid-cards');
                    Route::get('prepaid-cards/export', [PrepaidCardController::class, 'export'])->name('prepaid-cards.export');
                    Route::post('prepaid-cards/store', [PrepaidCardController::class, 'store'])->name('prepaid-cards.store');
                    Route::delete('prepaid-cards/delete/{prepaidCard}', [PrepaidCardController::class, 'destroy'])->name('prepaid-cards.destroy');
