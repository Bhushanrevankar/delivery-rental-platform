                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                    ...
                    <li class="nav-item max-sm-m-0 w-xxl-200px ml-auto flex-grow-0">
                        <button type="button" id="modalOpener"
                            ...
                            <div class="align-items-center d-flex flex-grow-1 gap-1 justify-content-between">
                                ...
                                <img width="14" class="h-auto"
                                    src="{{ asset('/public/assets/admin/img/new-img/search.svg') }}" class="svg"
                                    alt="">
                            </div>
                        </button>
                    </li>
                        ...
                        <a class="btn btn-icon rounded-circle nav-msg-icon" href="{{ route('admin.message.list') }}">
                            ...
                            @php
                                $message = \App\Models\Conversation::whereUserType('admin')
                                    ->whereHas('last_message', function ($query) {
                    ...
                    <div class="nav-item __nav-item">
                        <a href="javascript:void(0)" class="__nav-link module--nav-icon" id="tourb-0">
                            @if ($mod)
                                <img src="{{ $mod->icon_full_url }}" class="onerror-image"
