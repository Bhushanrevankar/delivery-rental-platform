        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    <!-- Ride sharing -->
                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-sharing/report*') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('admin.ride.report') }}"
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.ride_sharing_section') }}">{{ translate('messages.ride') }}
                            {{ translate('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-sharing/vehicle-category*') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('admin.ride.vehicle-category.index') }}"
                            title="{{ translate('Ride Category') }}">
                            <span class="tio-car nav-icon"></span>
                            <span class="text-truncate">{{ translate('Ride Category') }}</span>
                        </a>
                    </li>

                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-sharing/request*') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('admin.ride.request.index') }}"
                            title="{{ translate('messages.ride_requests') }}">
                            <span class="tio-clock nav-icon"></span>
                            <span class="text-truncate">{{ translate('messages.ride_requests') }}</span>
                        </a>
                    </li>

                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-sharing/settings') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('admin.ride.settings') }}"
