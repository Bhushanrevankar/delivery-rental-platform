            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('deliveryman'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/prepaid-cards*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.users.delivery-man.prepaid-cards') }}"
                                title="{{ translate('messages.prepaid_cards') }}">
                                <i class="tio-credit-card nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('messages.prepaid_cards') }}
                                </span>
                            </a>
                        </li>
                    @endif
                    ...
                    <!-- Subscription -->
                    <li class="nav-item">
                        <small class="nav-subtitle" title="Subscription">Subscription</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/packages*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.packages.index') }}" title="Packages">
                            <i class="tio-archive nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Packages</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/list*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.list.index') }}" title="Subscriptions">
                            <i class="tio-user-big nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Subscriptions</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/credit-rules*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.credit-rules.index') }}" title="Credit Deduction Rules">
                            <i class="tio-settings nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Credit Rules</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/bringfix/packages*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.bringfix.packages.index') }}" title="Bringfix Packages">
                            <i class="tio-briefcase nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Bringfix Packages</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/bringfix/list*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.bringfix.list.index') }}" title="Bringfix Subscriptions">
                            <i class="tio-group-senior nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Bringfix Subscriptions</span>
                        </a>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/subscription/transactions*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.subscription.transactions.index') }}" title="Credit Transactions">
                            <i class="tio-money nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Credit Transactions</span>
                        </a>
                    </li>
                    <!-- End Subscription -->
