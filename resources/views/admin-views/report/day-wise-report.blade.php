                    ...
                    <div class="row g-2">
                        <div class="col-md-12">
                            <div class="__card-vertical">
                                ...
                                <h4 class="earning" style="color: var(--primary-clr)">
                        ...
                        <tbody id="set-rows">
                            @foreach ($order_transactions as $k => $ot)
                                <tr scope="row">
                                    ...
                                    {{-- total_item_amount --}}
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order['order_amount'] - $ot->additional_charge - $ot->order['dm_tips'] - $ot->order['delivery_charge'] - $ot['tax'] - $ot->order['extra_packaging_amount'] + $ot->order['coupon_discount_amount'] + $ot->order['store_discount_amount'] + $ot->order['ref_bonus_amount'] + $ot->order['flash_admin_discount_amount'] + $ot->order['flash_store_discount_amount']) }}
                                    </td>

                                    {{-- item_discount --}}
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order->details()->sum(DB::raw('discount_on_item * quantity')) + $ot->order['flash_admin_discount_amount'] + $ot->order['flash_store_discount_amount']) }}
                                    </td>
                                    ...
                                    {{-- referral_discount --}}
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->order['ref_bonus_amount']) }}
                                    </td>
                                    {{-- discounted_amount --}}
                                    <td class="white-space-nowrap">
                                    ...
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->extra_packaging_amount) }}
                                    </td>
                                    <td class="white-space-nowrap">
