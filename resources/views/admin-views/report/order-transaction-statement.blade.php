...
<div class="">
    <div class="content-position-y">
        <table class="customers bs-0">
            <thead>
                <tr>
                    <th style="background-color: var(--primary-clr) important">{{translate('SL')}}</th>
                    <th style="background-color: var(--primary-clr) important">{{translate('details')}}</th>
                    <th style="background-color: var(--primary-clr) important">{{translate('amount')}}</th>
                </tr>
            </thead>
            @php
            @endphp
