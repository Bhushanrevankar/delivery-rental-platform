    ...
    <form action="{{ route('admin.users.delivery-man.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-0">
                                    ...
                                    <select name="zone_ids[]" class="form-control js-select2-custom" required
                                        multiple data-placeholder="{{ translate('messages.select_zone') }}">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 btn--container justify-content-end">
