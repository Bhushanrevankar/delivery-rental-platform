        ...
        <div class="card">
            ...
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-end">
                    ...
                    @endif
                    {{-- <div class="min--200">
                        <select name="ride_zone_id" class="form-control js-select2-custom set-filter"
                            data-filter="ride_zone_id" data-url="{{ url()->full() }}">
                            <option value="all">{{ translate('messages.All_Ride_Zones') }}</option>
                            @foreach (\App\Models\RideZone::orderBy('name')->get() as $z)
                                <option value="{{ $z['id'] }}"
                                    {{ isset($rideZone) && $rideZone->id == $z['id'] ? 'selected' : '' }}>
                                    {{ $z['name'] }}
                                </option>
                            @endforeach
                        </select>
                ...
                <table id="columnSearchDatatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0 text-capitalize">{{ translate('messages.zones') }}</th>
                    ...
                    <tbody id="set-rows">
                        @foreach ($deliveryMen as $key => $dm)
                            <tr>
                                ...
                                <td>
                                    @if ($dm->zones->isNotEmpty())
                                        <label
                                            class="text--title font-medium mb-0">{{ $dm->zones->map(function ($z) {return $z->name;})->join(', ') }}</label>
                                    @else
                                        <label class="text--title font-medium mb-0">None</label>
                                    @endif
                                </td>
                                <td>
                                    <a class="deco-none"
