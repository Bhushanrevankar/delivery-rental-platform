                            ...
                            @foreach($reviews as $key=>$review)
                                ...
                                <tr>
                                    ...
                                    <td><a class="text-dark"
                                           href="{{ $review->order_id != null ? route((isset($review->order) && $review?->order?->order_type=='parcel')?'admin.parcel.order.details':'admin.order.details',[$review->order_id,'module_id'=>$review?->order?->module_id]) : '#' }}">{{$review->order_id}}</a>
                                    </td>
                                    <td>
