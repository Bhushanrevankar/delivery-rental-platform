        ...
        <div class="page-header">
            ...
            <div class="alert alert-soft-primary alert-dismissible fade show d-flex" role="alert">
                ...
                <div class="w-0 flex-grow-1 pl-3">
                    ...
                    {{ translate('Don’t_forget_to_click_the_‘Add_Module’_button_below_to_save_the_new_business_module') }}
                </div>
                ...
                <div class="card-body pb-0">
                    ...
                    @if ($language)
                        <div class="lang_form p-1 mb-2" id="default-form">
                            ...
                            <div class="form-group">
                                <label class="input-label d-flex">{{ translate('Business_Module_description') }}
                                ...
                                <div class="card-body">
                                    <div class="row h-100">
                                        <div class="col-sm-6 mb-4 mb-sm-0">
                                            <div
                                                class="form-group m-0 h-100 d-flex align-items-center flex-column justify-content-center">
                                                ...
                                                <label class="text-center my-auto position-relative">
                                                    <img class="img--176 h-unset aspect-ratio-1 image--border"
                                                        id="viewer"
                                        ...
                                        <div class="col-sm-6">
                                            <div
                                                class="form-group m-0 h-100 d-flex flex-column justify-content-center align-items-center">
