...
@section('title', translate('Edit Company Account'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.edit') }} {{ translate('messages.company') }}
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.company-accounts.update', [$companyAccount->id]) }}"
                            method="post" enctype="multipart/form-data" id="company-account-form">
                            @csrf
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="nickname" id="nickname" type="text" class="form-control"
                                            ...
                                            value="{{ $companyAccount->nickname }}" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="bank_name" id="bank-name" class="form-control" required>
                                            ...
                                            <option value="GCash"
                                                {{ $companyAccount->bank_name == 'GCash' ? 'selected' : '' }}>
                                                GCash</option>
                                            <option value="Paymaya"
                                                {{ $companyAccount->bank_name == 'Paymaya' ? 'selected' : '' }}>Paymaya
                                            </option>
                                            <option value="BDO"
                                                {{ $companyAccount->bank_name == 'BDO' ? 'selected' : '' }}>BDO</option>
                                            <option value="BPI"
                                                {{ $companyAccount->bank_name == 'BPI' ? 'selected' : '' }}>BPI</option>
                                            <option value="Chinabank"
                                                {{ $companyAccount->bank_name == 'Chinabank' ? 'selected' : '' }}>Chinabank
                                            </option>
                                            <option value="Metrobank"
                                                {{ $companyAccount->bank_name == 'Metrobank' ? 'selected' : '' }}>Metrobank
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input name="account_name" id="account-name" type="text" class="form-control"
                                            ...
                                            value="{{ $companyAccount->account_name }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label"
                                        ...
                                        <input name="account_number" id="account-number" type="text" class="form-control"
                                            ...
                                            value="{{ $companyAccount->account_number }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        ...
                                        <center class="py-3 my-auto">
                                            <img class="img--vertical" id="viewer"
                                                ...
                                                src="{{ $companyAccount->qr_img_url }}" alt="qr image" />
                                        </center>
