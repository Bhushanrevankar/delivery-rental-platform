                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="">
                                        ...
                                        <ol>
                                            <li>{{ translate('After purchasing the ') }}
                                                <strong>{{ translate('Payment & SMS Module/Rental Module') }}</strong>
                                                {{ translate('from Codecanyon, you will find a file download option.') }}
                                            </li>
                                            <li>{{ translate('Download the file. It will be downloaded as Zip format Filename.Zip.') }}
                                            </li>
                                            <li>{{ translate('Extract the file and you will get another file name Filename.zip.') }}
                                            </li>
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal"
                                        data-target="#deleteThemeModal_{{ $key }}"><img
                                            src="{{ asset('public/assets/admin/img/delete.svg') }}" class="svg"
                                            alt=""></button>
                                    <!-- Delete Theme Modal -->
                                ...
                                <button
                                    ...
                                    data-toggle="modal" data-target="#shiftThemeModal_{{ $key }}"><img
                                        src="{{ asset('public/assets/admin/img/check.svg') }}" class="svg"
                                        alt=""></button>
                                    ...
                                    <div class="modal-dialog status-warning-modal">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 pt-0 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75"
                                                        src="{{ asset('public/assets/admin/img/shift.png') }}"
                                                        alt="">
                                                </div>
