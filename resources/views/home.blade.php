...
@section('content')
    ...
    <section class="banner-section position-relative">
        ...
        <div class="px-xl-5 d-flex justify-content-center text-base banner-svg-img">
            <img src="{{ asset('public/assets/landing/img/web-home1.png') }}" style="width: 80%; max-width: 1200px"
                alt="banner-image">
        </div>
    </section>
                    ...
                    <div class="position-relative dropdown text-capitalize z-2">
                        ...
                        @if (isset($join_as_seller['playstore_url_status']) &&
                            ...
                            <button type="button" class="cmn--btn border-0" data-bs-toggle="dropdown">
                                ...
                                <svg class="ms-2" width="12" height="7" viewBox="0 0 12 7" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-lg-6 col-md-9">
                        <div class="download-app-content wow fadeInUp">
                            ...
                            <div class="position-relative dropdown text-capitalize">
                                <button type="button"
                                    class="cmn--btn border-0 w-75 w-sm-50 d-flex justify-content-between align-items-center"
