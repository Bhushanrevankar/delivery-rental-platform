...
--
-- Host: localhost:8889
-- Generation Time: Oct 18, 2022 at 04:58 AM
...
--
-- Database: `6amMart_client_oscar_install`
--
...
(112, 'ride_sharing_status', '1', '2022-10-17 17:58:13', '2022-10-17 17:58:13'),
(113, 'ride_sharing_admin_commission', '30', '2022-10-17 17:58:13', '2022-10-17 17:58:13'),
(114, 'ride_sharing_tax', '7', '2022-10-17 17:58:13', '2022-10-17 17:58:13');
...
CREATE TABLE `delivery_men` (
  ...
  `ride_sharing` tinyint(1) NOT NULL DEFAULT '0',
  `vehicle_reg_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_rc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_owner_noc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ride_zone_id` bigint(20) UNSIGNED DEFAULT NULL,
  `ride_category_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `ignore_ride_logs`
--

CREATE TABLE `ignore_ride_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(26, '2022_09_28_112449_add_vehicle_column_to_delivery_men_table', 37),
(27, '2022_09_28_113639_create_ride_zones_table', 37),
(28, '2022_09_28_121007_create_ride_categories_table', 37),
(29, '2022_10_02_105647_create_ride_requests_table', 37),
(30, '2022_10_02_113417_create_ride_log_histories_table', 37),
(31, '2022_10_02_120605_create_ongoing_ride_logs_table', 37),
(32, '2022_10_02_120834_create_ignore_ride_logs_table', 37),
(33, '2022_10_12_182205_create_ride_transactions_table', 37),
(34, '2022_10_12_205254_add_ride_request_id_to_d_m_reviews_table', 37);
...
--
-- Table structure for table `ongoing_ride_logs`
--

CREATE TABLE `ongoing_ride_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ride_request_id` bigint(20) UNSIGNED NOT NULL,
  `delivery_man_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `ride_categories`
--
...
CREATE TABLE `ride_categories` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `base_fare` double(16,3) NOT NULL,
  `per_km_fare` double(16,3) NOT NULL,
  `per_min_waiting_fare` double(16,3) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `ride_log_histories`
--

CREATE TABLE `ride_log_histories` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ride_request_id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `ride_requests` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `delivery_man_id` bigint(20) UNSIGNED DEFAULT NULL,
  `ride_category_id` bigint(20) UNSIGNED NOT NULL,
  `ride_zone_id` bigint(20) UNSIGNED NOT NULL,
  `ride_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_point` point NOT NULL,
  `pickup_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dropoff_point` point NOT NULL,
  `dropoff_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estimated_time` double(8,2) NOT NULL,
  `estimated_fare` decimal(23,3) NOT NULL,
  `actual_time` double(8,2) DEFAULT NULL,
  `actual_fare` decimal(23,3) DEFAULT NULL,
  `estimated_distance` double(8,2) NOT NULL,
  `actual_distance` double(8,2) DEFAULT NULL,
  `actual_pickup_point` point DEFAULT NULL,
  `actual_dropoff_point` point DEFAULT NULL,
  `pickup_time` timestamp NULL DEFAULT NULL,
  `dropoff_time` timestamp NULL DEFAULT NULL,
  `total_fare` decimal(23,3) DEFAULT NULL,
  `tax` decimal(23,3) DEFAULT NULL,
  `otp` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `ride_transactions`
--

CREATE TABLE `ride_transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ride_request_id` bigint(20) UNSIGNED NOT NULL,
  `delivery_man_id` bigint(20) UNSIGNED NOT NULL,
  `total_fare` decimal(23,3) NOT NULL,
  `tax` decimal(23,3) NOT NULL,
  `admin_commission` decimal(23,3) NOT NULL,
  `rider_commission` decimal(23,3) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `ignore_ride_logs`
--
ALTER TABLE `ignore_ride_logs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ongoing_ride_logs`
--
ALTER TABLE `ongoing_ride_logs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ride_categories`
--
ALTER TABLE `ride_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ride_log_histories`
--
ALTER TABLE `ride_log_histories`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ride_transactions`
--
...
ALTER TABLE `ride_zones`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ride_zones_name_unique` (`name`);
...
--
-- AUTO_INCREMENT for table `ignore_ride_logs`
--
ALTER TABLE `ignore_ride_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ongoing_ride_logs`
--
ALTER TABLE `ongoing_ride_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ride_categories`
--
ALTER TABLE `ride_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ride_log_histories`
--
ALTER TABLE `ride_log_histories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ride_transactions`
--
ALTER TABLE `ride_transactions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
